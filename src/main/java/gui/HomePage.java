...
public class HomePage {
    ...
    private final By product = By.xpath("//*[@id=\"top-of-page\"]/div[2]/div/section[4]/div/div[2]/div/div/div[2]/div/a");
    ...
    private By wishListBtnForProduct = By.xpath("//*[@id=\"top-of-page\"]/div[2]/div/section[4]/div/div[2]/div/div/div[2]/div/div[1]/div[2]"); // xpath for product heart
...
//    }
    ...
    public ProductsPage gotoProductsPage(){
        driver.navigate().to("http://43.205.206.91/en/products");
    ...
    private By offerLabelCheck(By wishListBtnForProduct) {
        ...
        if (text.contains("% Off")) {
            wishListBtnForProduct = By.xpath("//*[@id=\"top-of-page\"]/div[2]/div/section[4]/div/div[2]/div/div/div[2]/div/div[1]/div[3]");
